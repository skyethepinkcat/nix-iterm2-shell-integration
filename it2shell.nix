...
stdenvNoCC.mkDerivation rec {
  ...
  installPhase = ''
    ...
    cp shell_integration/zsh $out/share/iterm2-shell-integration/iterm2_shell_integration.zsh
    cp shell_integration/bash $out/share/iterm2-shell-integration/iterm2_shell_integration.bash
    cp shell_integration/fish $out/share/iterm2-shell-integration/iterm2_shell_integration.fish
  '';
}
